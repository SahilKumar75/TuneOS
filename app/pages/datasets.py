...
STARTER_DATASETS = [
    {
        ...
        "rows": "52K",
        "desc": "Stanford Alpaca instruction-following — the classic starting point.",
    ...
    },
    {
        ...
        "category": "Code",
        "rows": "20K",
        "desc": "Code generation instructions in Alpaca format.",
        "license": "Apache 2.0",
    },
    {
        ...
        "category": "Math",
        "rows": "262K",
        "desc": "Math reasoning with chain-of-thought solutions.",
        "license": "MIT",
    },
    {
        "id": "allenai/sciq",
    ...
    },
    {
        ...
        "category": "Code",
        "rows": "18K",
        "desc": "Python code generation instructions.",
        "license": "Apache 2.0",
    },
    {
        ...
        "category": "Chat",
        "rows": "1.5M",
        "desc": "Large-scale multi-turn chat dataset.",
        "license": "CC BY NC 4.0",
    },
    {
        ...
        "category": "Instruction",
        "rows": "70K",
        "desc": "Evolved instruction dataset for complex tasks.",
        "license": "Apache 2.0",
    },
]
            ...
            rx.vstack(
                rx.hstack(
                    ...
                    rx.button(
                        ...
                        size="2",
                        color_scheme="blue",
                        on_click=DatasetState.use_in_finetune(DatasetState.preview_dataset_id),
                    ),
                    spacing="2",
                    align="center",
                    width="100%",
                ...
                rx.cond(
                    ...
                    rx.vstack(
                        rx.text(
                            "Columns: " + DatasetState.preview_columns.join(", "),
                            font_size="0.74rem",
                            color=c("text_muted"),
                        ),
                        rx.table.root(
    ...
    return rx.hstack(
        ...
        rx.box(
            rx.vstack(
                ...
                rx.hstack(
                    rx.heading(
                        "Datasets", font_size="1.3rem", font_weight="600", color=c("text_primary")
                    ),
                    rx.spacer(),
                    align="center",
                    width="100%",
                ...
                rx.cond(
                    ...
                    rx.vstack(
                        rx.text(
                            f"Search results ({DatasetState.search_results.length()})",
                            font_size="0.82rem",
                            color=c("text_muted"),
                        ),
                        rx.vstack(
